...
def run():
    ...
    info('\n** Adding Hosts\n')
    r1 = net.addHost('r1' , ip = '73.8.38.5/24' , hostname = 'r1' , privateLogDir=True, privateRunDir=True, inMountNamespace=True, inPIDNamespace=True, inUTSNamespace=True)
    h1 = net.addHost('h1' , ip = '73.8.38.1/24' , hostname = 'h1' , privateLogDir=True, privateRunDir=True, inMountNamespace=True, inPIDNamespace=True, inUTSNamespace=True)
    h2 = net.addHost('h2' , ip = '73.8.38.2/24' , hostname = 'h2' , privateLogDir=True, privateRunDir=True, inMountNamespace=True, inPIDNamespace=True, inUTSNamespace=True)
    
    h3 = net.addHost('h3' , ip = '73.8.2.3/24'  , hostname = 'h3' , privateLogDir=True, privateRunDir=True, inMountNamespace=True, inPIDNamespace=True, inUTSNamespace=True)
    h4 = net.addHost('h4' , ip = '73.8.2.4/24'  , hostname = 'h4' , privateLogDir=True, privateRunDir=True, inMountNamespace=True, inPIDNamespace=True, inUTSNamespace=True)
    ...
    r1.cmd('ifconfig r1-eth1 73.8.2.5 netmask 255.255.255.0')

    h1.cmd('echo 1 > /proc/sys/net/ipv4/ip_forward')
    
    h1.cmd('ip route add default via 73.8.38.5/24')
    h2.cmd('ip route add default via 73.8.38.5/24')
    h3.cmd('ip route add default via 73.8.2.5/24')
    h4.cmd('ip route add default via 73.8.2.5/24')


    r1.cmd('iptables -t nat -A PREROUTING -p  ICMP -s 73.8.38.1  -d  73.8.2.3  -j DNAT --to 73.8.2.5')
    r1.cmd('iptables -t nat -A POSTROUTING -p ICMP -s 73.8.2.3   -d  73.8.2.5  -j SNAT --to 73.8.38.1')
