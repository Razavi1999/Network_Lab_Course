...
def run():
    ...
    info('\n** Adding Hosts\n')
    h1 = net.addHost('h1', ip='57.17.91.1/24', hostname='h1',  privateLogDir=True, privateRunDir=True, inMountNamespace=True, inPIDNamespace=True, inUTSNamespace=True)
    h2 = net.addHost('h2', ip='57.17.91.2/24', hostname='h2',  privateLogDir=True, privateRunDir=True, inMountNamespace=True, inPIDNamespace=True, inUTSNamespace=True)
    h3 = net.addHost('h3', ip='57.17.11.3/24', hostname='h3',  privateLogDir=True, privateRunDir=True, inMountNamespace=True, inPIDNamespace=True, inUTSNamespace=True)
    h4 = net.addHost('h4', ip='57.17.11.4/24', hostname='h4',  privateLogDir=True, privateRunDir=True, inMountNamespace=True, inPIDNamespace=True, inUTSNamespace=True)
    r1 = net.addHost('r1', ip='57.17.91.5/24', hostname='r1',  privateLogDir=True, privateRunDir=True, inMountNamespace=True, inPIDNamespace=True, inUTSNamespace=True)
    ...
    r1.cmd('ifconfig r1-eth1 57.17.11.5 netmask 255.255.255.0')
    r1.cmd('echo 1 > /proc/sys/net/ipv4/ip_forward')
    h1.cmd('ip route add default via 57.17.91.5')
    h2.cmd('ip route add default via 57.17.91.5')
    h3.cmd('ip route add default via 57.17.11.5')
    h4.cmd('ip route add default via 57.17.11.5')

    r1.cmd('iptables -t nat -A PREROUTING -p ICMP -s 57.17.91.1 -d 57.17.11.3 -j DNAT --to 57.17.11.4')
    r1.cmd('iptables -t nat -A POSTROUTING -p ICMP -s 57.17.91.1 -d 57.17.11.3 -j SNAT --to 57.17.11.5')
