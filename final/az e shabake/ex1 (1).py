...
def run():
    ...
    info('\n** Adding Hosts\n')
    h1 = net.addHost('h1', ip='24.30.65.1/24', hostname='h1')
    h2 = net.addHost('h2', ip='24.30.65.2/24', hostname='h2')
    h3 = net.addHost('h3', ip='24.30.90.3/24', hostname='h3')
    h4 = net.addHost('h4', ip='24.30.90.4/24', hostname='h4')
    r1 = net.addHost('r1', ip='24.30.65.5/24', hostname='r1')
    ...
    r1.cmd('ifconfig r1-eth1 24.30.90.5 netmask 225.225.225.0')
    ...
    # Q2
    h1.cmd('iptables -t nat -A POSTROUTING -o h1-eth0 -d 24.30.90.3 -j SNAT --to 24.30.90.5')
    r1.cmd('iptables -t nat -A PREROUTING -p ICMP -d 24.30.90.3 -j DNAT --to 24.30.90.4')
